...
def get_df_rouge_scores(scores, rouge_measures, columns, index, ref_length, summary_length, filtered, filtered_length = -1):
    rows = []
    for rouge_measure in rouge_measures:
        for score in scores:
            new_row = {'Reference data length': ref_length, 
